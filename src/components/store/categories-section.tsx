      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            : categories.map((category, i) => {
                ...
                return (
                  <motion.button
                    ...
                    className="category-shine group relative flex min-h-[200px] flex-col items-start overflow-hidden rounded-xl border border-border bg-card p-6 text-left transition-all duration-300 hover:border-cyan-500/40 hover:shadow-lg hover:shadow-cyan-500/10"
                  >
                    {/* Background Pattern */}
                    <div
                    ...
                    <div className="relative z-10 flex w-full items-start justify-between">
                      {/* Icon */}
                      <div className="icon-pulse-hover mb-4 flex size-12 items-center justify-center rounded-xl border border-border/50 dark:border-border/50 border-neutral-300 bg-muted/80 dark:bg-muted/80 bg-muted transition-all duration-300 group-hover:border-cyan-500/30 group-hover:bg-cyan-500/10 group-hover:shadow-md group-hover:shadow-cyan-500/10">
                        <IconComponent className="size-5 text-muted-foreground transition-colors duration-300 group-hover:text-cyan-400" />
                      </div>

                      {/* Product Count Badge */}
                      <div className="flex items-center gap-1 rounded-full bg-muted/80 dark:bg-muted/80 bg-muted px-2.5 py-1 text-[10px] font-medium text-muted-foreground transition-all duration-300 group-hover:bg-cyan-500/10 group-hover:text-cyan-400">
                    ...
                    <div className="relative z-10">
                      <h3 className="mb-1 text-lg font-semibold text-foreground transition-colors duration-300 group-hover:text-cyan-400">
                        {category.name}
                      </h3>
                      ...
                      <div className="mt-3 flex items-center gap-1.5 text-xs font-medium text-muted-foreground transition-colors duration-300 group-hover:text-cyan-400">
        ...
        <div className="mt-8 flex justify-center">
          <button
            ...
            className="group flex items-center gap-2 rounded-full border border-border bg-card/50 px-5 py-2.5 text-sm font-medium text-muted-foreground transition-all duration-300 hover:border-cyan-500/40 hover:bg-cyan-500/5 hover:text-cyan-400 hover:shadow-md hover:shadow-cyan-500/5"
          >
            View All Categories
